...
add column is_practice_day boolean not null default false,
add column practice_day_title text,
add column practice_day_description text,
add column practice_day_image_url text;
