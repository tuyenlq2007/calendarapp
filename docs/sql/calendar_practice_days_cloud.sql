...
add column if not exists is_practice_day boolean not null default false,
add column if not exists practice_day_title text,
add column if not exists practice_day_description text,
add column if not exists practice_day_image_url text;
...
begin
  ...
  public_fields_changed := row(
    ...
    new.is_practice_day,
    new.practice_day_title,
    new.practice_day_description,
    new.practice_day_image_url,
    new.status,
    new.published_at
    ...
    old.is_practice_day,
    old.practice_day_title,
    old.practice_day_description,
    old.practice_day_image_url,
    old.status,
    old.published_at
  );
